...
export default {
    ...
    boardsImagePath:path.join(process.cwd(),'/src/temp/boards'),//牌模板的目录
    suitsImagePath:path.join(process.cwd(),'/src/temp/suits'),//花色模板的目录
    ...
    testImagePath:path.join(process.cwd(),'/src/temp/temp/test'),//测试的目录
}